...
const Contact = () => {
  ...
  return (
    <div className="bg-white">
      <SEO title="Contact Us | Perfect" description="Get in touch with us on WhatsApp or email." />
      ...
      <motion.div 
        ...
        animate="visible"
        variants={fadeIn}
        className="bg-theme-black text-white py-24 text-center px-4"
      >
        <p className="text-theme-yellow font-black uppercase tracking-[0.3em] text-xs mb-4">Get In Touch</p>
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-24">
        ...
        >
          ...
          <motion.div 
            variants={fadeIn} 
            whileHover="wiggle"
            className="group bg-white border-2 border-gray-100 hover:border-theme-black p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-[6px_6px_0px_#111]"
          >
          ...
          <motion.a
            ...
            className="group bg-theme-black border-2 border-theme-black p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-[6px_6px_0px_#FFEA00] cursor-pointer"
          >
            <div className="w-14 h-14 bg-theme-yellow text-theme-black flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <Phone size={24} />
            </div>
            <h3 className="text-base font-black uppercase tracking-widest text-theme-yellow mb-3">Phone Call</h3>
            <p className="text-gray-400 font-bold leading-relaxed text-lg mb-2">
              +91 {contactNum}
            </p>
            <span className="text-[10px] font-black uppercase tracking-widest text-theme-yellow border border-theme-yellow px-4 py-2 mt-4 inline-block hover:bg-theme-yellow hover:text-theme-black transition-colors">
              Call Now →
            </span>
          </motion.a>
